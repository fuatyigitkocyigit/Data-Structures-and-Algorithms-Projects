...
// Section: 2
// Assignment: 4
// Description: This class implements the StdRandom to use in Edge Weighted Graph class 
...
public final class StdRandom {
    ...
    public static long getSeed() {
		//--------------------------------------------------------
		// Summary: Returns the seed of the pseudo-random number generator.
		//--------------------------------------------------------
    ...
    public static double uniform() {
		//--------------------------------------------------------
		// Summary: Returns a random real number uniformly in [0, 1).
		//--------------------------------------------------------
    ...
    public static int uniform(int n) {
		//--------------------------------------------------------
		// Summary: Returns a random integer uniformly in [0, n).
		//--------------------------------------------------------
    ...
    public static long uniform(long n) {
		//--------------------------------------------------------
		// Summary: Returns a random long integer uniformly in [0, n).
		//--------------------------------------------------------
    ...
    public static int uniform(int a, int b) {
		//--------------------------------------------------------
		// Summary: Returns a random integer uniformly in [a, b).
		//--------------------------------------------------------
    ...
    public static double uniform(double a, double b) {
		//--------------------------------------------------------
		// Summary: Returns a random real number uniformly in [a, b).
		//--------------------------------------------------------
