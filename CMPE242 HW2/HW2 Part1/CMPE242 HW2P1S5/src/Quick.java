...
// Section: 3
// Assignment: 2
// Description: This class sorts the given persons according to their id's in ascending order with quick sort
//-----------------------------------------------------

import java.util.*;
import java.util.Random;

public class Quick { //STEP 6
	...
	public static void main(String[] args) {
		//--------------------------------------------------------
		// Summary: Sets person array and sorts it with the quick sort algorithm
		//--------------------------------------------------------
